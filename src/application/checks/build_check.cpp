...
BuildCheck::BuildCheck(const domain::config::Check& config)
...
domain::CheckResult BuildCheck::execute(const std::vector<std::string>& /*files*/,
  ...
  // Build commands take no file arguments; run once regardless of file set.
