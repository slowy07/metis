#ifndef METIS_APPLICATION_CHECKS_CLANG_FORMAT_CHECK_HPP
#define METIS_APPLICATION_CHECKS_CLANG_FORMAT_CHECK_HPP
...
#endif  // !METIS_APPLICATION_CHECKS_CLANG_FORMAT_CHECK_HPP
