#ifndef METIS_INFRASTRUCTURE_WINDOWS_CLANG_PROVIDER_HPP
#define METIS_INFRASTRUCTURE_WINDOWS_CLANG_PROVIDER_HPP
...
#endif  // !METIS_INFRASTRUCTURE_WINDOWS_CLANG_PROVIDER_HPP
