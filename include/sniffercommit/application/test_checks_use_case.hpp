#ifndef SNIFFERCOMMIT_APPLICATION_TEST_CHECKS_USE_CASE_HPP
#define SNIFFERCOMMIT_APPLICATION_TEST_CHECKS_USE_CASE_HPP
...
#endif  // !SNIFFERCOMMIT_APPLICATION_TEST_CHECKS_USE_CASE_HPP
